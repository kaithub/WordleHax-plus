...
<p>Click this button to restart the wordle. (To try the wordle again)<button class='Key-module_key__kchQI' type='button' onclick='localStorage.removeItem("nyt-wordle-moogle/ANON");'>Go</button></p>
