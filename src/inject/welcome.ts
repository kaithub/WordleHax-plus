...
<p>To make it easier, here's a refresh button. <button class='Key-module_key__kchQI' type='button' onclick='alert('Warning: You will need to reinject WH+.'); location.reload()'>Refresh</button></p>
